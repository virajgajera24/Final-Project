              ...
              <div className="collapse navbar-collapse" id="navbarMenu">
                <ul className="navbar-nav mr-auto">
                  ...
                  <li className="nav-item">
                       <a className="nav-link dropdown-toggle" href="javascript:void(0);" id="pageMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Department</a>
                       <div className="dropdown-menu">
                       <Link to={"/add-department"} className="dropdown-item">Add Department</Link>
                       <Link to={"/all-department"} className="dropdown-item">All Department</Link>
                    </div>
                    </li>
